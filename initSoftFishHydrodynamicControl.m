...
Setpoint1 = 0.4; % first value
SwitchTime1 = 15; % first step time in seconds
Setpoint2 = 0.6; % second value
SwitchTime2 = 30; % second step time
Setpoint3 = 0.4; % final value
...
OptimizedModel = ['optimizedModel_Water_10cHz_10cbar_OVER0'];
load(OptimizedModel);
